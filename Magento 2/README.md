...
- [Forma alternativa para pesquisar por elementos de uma página](./topics/pesquisa-alternativa.md)
- [Como mover elementos de uma página](./topics/movendo.md)
- [Como remover um container](./topics/remover.md)
- [Como criar um container e aplicar uma classe CSS](./topics/criar-e-css.md)
...
- [A relação entre arquivos de layout (xml) e componentes js](./topics/magento-xmlecomponentes.md)
...
- [Passo-a-passo: Desenvolvendo seu primeiro teste unitário](./topics/unittest-passo-a-passo.md)
- [Teste unitário: How to's](./topics/unittest-howto.md)
